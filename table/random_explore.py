...
# Experiment name
tf.flags.DEFINE_string('output_dir', '/Users/qingwang/PycharmProjects/data/wikisql/output', 'output directory')
tf.flags.DEFINE_string('experiment_name', 'mml_test',
...
tf.app.flags.DEFINE_string(
  'table_file', '/Users/qingwang/PycharmProjects/data/wikisql/processed_input/preprocess_2/tables.jsonl', '.')
tf.app.flags.DEFINE_string(
